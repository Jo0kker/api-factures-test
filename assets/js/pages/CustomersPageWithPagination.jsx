...
const CustomersPageWithPagination = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`https://localhost:8000/api/clients?pagination=true&count=${itemsPerPage}&page=${currentPage}`)
            .then(response => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete("https://localhost:8000/api/clients/" + id)
    ...
    return (
        <>
            <h1>Liste des clients (avec pagination)</h1>
